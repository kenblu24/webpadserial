export var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; };

/*! Controller.js - v1.0.2 - 2017-05-17 */
export function Controller(HTMLgamepad) {
    ...
    function loopThroughButtons() {
        ...
        for (var name in inputs) {
            ...
            var value;
            if (_typeof(gamepad[section][_index3]) === "object")
                value = gamepad[section][_index3].value;
            else
                value = gamepad[section][_index3];
